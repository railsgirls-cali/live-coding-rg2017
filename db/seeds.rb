...
Recipe.create(name: 'Jugo de aloe vera', picture: "http://i.ndtvimg.com/i/2015-09/aloe-vera-625_625x350_71443086188.jpg", description: "El aloe vera o sábila es una de esas plantas medicinales con múltiples beneficios para la salud tanto a nivel interno como externo. Tomar todos los días su jugo contribuye a limpiar de manera natural el colon y facilitar la eliminación de los desechos.", disease_id: 3)
